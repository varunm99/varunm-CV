...
\begin{center}
    ...
    $|$
    \faAt \hspace{.5pt}
    \href{mailto:v.madabushi917@gmail.com}{v.madabushi917@gmail.com}
    $|$
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Robotics Engineer}{Jun 2022 \textbf{--} Present}
        \resumeItemListStart
      \resumeItem{Developed co-design algorithm using bayesian optimization to
      select leg designs and gait patterns for hexapod robot}
